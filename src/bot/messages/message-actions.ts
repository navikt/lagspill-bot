...
export function newGameActionElement(gameCategory: GameCategory) {
   return {
...
export function startGameActionElement(game: Game) {
    return {
...
export function finishGameActionElement(game: Game) {
    return {
...
export function deleteGameActionElement(game: Game) {
    return {
...
export function newGameCategoryActionElement() {
    return {
